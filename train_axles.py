...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if len(args.pretrained_weight) > 0:
        ...
        print("Loaded: %s" % args.pretrained_weight)
    ...
    lr_scheduler = CosineAnnealingLR(optimizer=optimizer, T_max=args.epochs * len(train_dataset) // args.batch_size // ngpus_per_node)
